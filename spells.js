...
class HealRayEffect {
    ...
    update() {
        ...
        if (this.hitDistance != null && tickNumber % 10 == 0) {
...
class AllSpells {
    constructor() {
        ...
        this.basicBow = AllSpells.basicBow();
    ...
    static basicBow() {
        ...
        projectile.damage = 5;
        const spell = new ThrowProjectileSpell(projectile);
        spell.sprite = getRavenSprite(4, 111);
        spell.cooldown = 0.7;
        spell.castingTime = 0;
        spell.description = new SpellDescription("Mouse 1", "Wood Bow", "white", ["A long range weak attack"]);
        return spell;
    }
    static shotgun() {
